export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	aggron: {
		...
		evoLevel: 42,
		eggGroups: ["Monster"],
		otherFormes: ["Aggron-Mega", "Aggron-Heroguea"],
		formeOrder: ["Aggron", "Aggron-Mega", "Aggron-Heroguea"],
	},
	aggronmega: {
		num: 306,
		name: "Aggron-Mega",
	...
	shuppet: {
		...
		evos: ["Banette"],
		eggGroups: ["Amorphous"],
		otherFormes: ["Shuppet-Heroguea"],
		formeOrder: ["Shuppet", "Shuppet-Heroguea"],
	},
	banette: {
		num: 354,
		name: "Banette",
	...
	spiritomb: {
		...
		color: "Purple",
		eggGroups: ["Amorphous"],
		otherFormes: ["Spiritomb-Heroguea"],
		formeOrder: ["Spiritomb", "Spiritomb-Heroguea"],
	},
	gible: {
		num: 443,
		name: "Gible",
	...
	komala: {
		...
		color: "Blue",
		eggGroups: ["Field"],
		otherFormes: ["Komala-Heroguea"],
		formeOrder: ["Komala", "Komala-Heroguea"],
	},
	turtonator: {
		num: 776,
		name: "Turtonator",
	...
	styrangel: {
		...
		name: "Styrangel",
		types: ["Grass"],
		baseStats: { hp: 40, atk: 50, def: 40, spa: 70, spd: 45, spe: 75 },
	...
	cifluim: {
		...
		name: "Cifluim",
		types: ["Grass","Fairy"],
		baseStats: { hp: 60, atk: 60, def: 50, spa: 90, spd: 65, spe: 95 },
		abilities: { 0: "Overgrow", H: "Tinted Lens" },
		heightm: 0.8,
		weightkg: 13.6,
		color: "Green",
	...
	styrafim: {
		...
		name: "Styrafim",
		types: ["Grass","Fairy"],
		baseStats: { hp: 72, atk: 70, def: 65, spa: 108, spd: 98, spe: 117 },
		abilities: { 0: "Overgrow", H: "Tinted Lens" },
		heightm: 1.8,
		weightkg: 61.7,
		color: "Black",
		...
		evoLevel: 32,
		eggGroups: ["Flying"],
		otherFormes: ["Styrafim-Mega"],
		formeOrder: ["Styrafim", "Styrafim-Mega"],
		gen: 9,
	},
	styrafimmega: {
		num: -1002,
		name: "Styrafim-Mega",
		types: ["Grass","Fairy"],
		baseSpecies: "Styrafim",
		forme: "Mega",
		baseStats: { hp: 72, atk: 80, def: 85, spa: 128, spd: 118, spe: 147 },
		abilities: { 0: "Holy Eyes"},
		heightm: 1.8,
		weightkg: 70.8,
		color: "Black",
		eggGroups: ["Flying"],
		requiredItem: "Styrafimite",
		gen: 9,
	},
	lambabel: {
		num: -1003,
		name: "Lambabel",
		types: ["Fire"],
		baseStats: { hp: 65, atk: 50, def: 60, spa: 55, spd: 40, spe: 50 },
	...
	asheap: {
		...
		name: "Asheap",
		types: ["Fire","Flying"],
		baseStats: { hp: 85, atk: 65, def: 85, spa: 79, spd: 51, spe: 55 },
		abilities: { 0: "Blaze", H: "Fluffy" },
		heightm: 0.8,
		weightkg: 67.9,
		color: "Yellow",
	...
	baasphyx: {
		...
		name: "Baasphyx",
		types: ["Fire","Flying"],
		baseStats: { hp: 91, atk: 91, def: 109, spa: 111, spd: 60, spe: 68 },
		abilities: { 0: "Blaze", H: "Fluffy" },
		heightm: 1.4,
		weightkg: 182.4,
		color: "Yellow",
		...
		evoLevel: 32,
		eggGroups: ["Field"],
		otherFormes: ["Baasphyx-Mega"],
		formeOrder: ["Baasphyx", "Baasphyx-Mega"],
		gen: 9,
	},
	baasphyxmega: {
		num: -1005,
		name: "Baasphyx-Mega",
		types: ["Fire","Flying"],
		baseSpecies: "Baasphyx",
		forme: "Mega",
		baseStats: { hp: 91, atk: 121, def: 139, spa: 131, spd: 80, spe: 68 },
		abilities: { 0: "Billowing Smoke"},
		heightm: 1.7,
		weightkg: 159.7,
		color: "Black",
		eggGroups: ["Field"],
		requiredItem: "Baasphyxite",
		gen: 9,
	},
	eeglur: {
		num: -1006,
		name: "Eeglur",
		types: ["Water"],
		baseStats: { hp: 70, atk: 45, def: 60, spa: 45, spd: 60, spe: 40 },
	...
	solesteelir: {
		...
		name: "Solesteelir",
		types: ["Water"],
		baseStats: { hp: 100, atk: 60, def: 80, spa: 60, spd: 80, spe: 40 },
		abilities: { 0: "Torrent", H: "Soul Siphon" },
		heightm: 1.1,
		weightkg: 2.4,
		color: "Blue",
	...
	reelinger: {
		...
		evoLevel: 32,
		eggGroups: ["Water 1", "Amorphous"],
		otherFormes: ["Reelinger-Mega"],
		formeOrder: ["Reelinger", "Reelinger-Mega"],
		gen: 9,
	},
	reelingermega: {
		num: -1008,
		...
		forme: "Mega",
		types: ["Water","Ghost"],
		baseStats: { hp: 130, atk: 130, def: 110, spa: 130, spd: 110, spe: 20 },
		abilities: { 0:"Soul Reaper" },
		heightm: 5.0,
		weightkg: 200.0,
		color: "Blue",
		eggGroups: ["Water 1", "Amorphous"],
		requiredItem: "Reelingerite",
		gen: 9,
	},
	clawtify: {
		num: -1009,
		name: "Clawtify",
		types: ["Normal"],
		baseStats: { hp: 90, atk: 60, def: 60, spa: 15, spd: 15, spe: 40 },
		abilities: { 0: "Sturdy", 1: "Mirror Armor", H: "Intimidate" },
		heightm: 0.4,
		weightkg: 64.0,
		color: "White",
		evos: ["Clawmmortal"],
	...
	clawmmortal: {
		...
		name: "Clawmmortal",
		types: ["Normal","Fairy"],
		baseStats: { hp: 102, atk: 95, def: 60, spa: 55, spd: 85, spe: 50 },
		abilities: { 0: "Fur Coat", 1: "Mirror Armor", H: "Intimidate" },
		heightm: 1.5,
		weightkg: 121.0,
		color: "White",
		prevo: "Clawtify",
	...
	warnet: {
		...
		name: "Warnet",
		types: ["Bug","Fighting"],
		baseStats: { hp: 45, atk: 79, def: 45, spa: 30, spd: 57, spe: 64 },
		abilities: { 0: "Moxie", 1: "Swarm", H: "Stakeout" },
		heightm: 0.5,
		weightkg: 5.0,
		color: "White",
		evos: ["Arthrogue"],
	...
	arthrogue: {
		...
		name: "Arthrogue",
		types: ["Bug","Fighting"],
		baseStats: { hp: 75, atk: 119, def: 65, spa: 30, spd: 77, spe: 104 },
		abilities: { 0: "Moxie", 1: "Swarm", H: "Stakeout" },
		heightm: 1.2,
		weightkg: 30.0,
		color: "White",
	...
	swimper: {
		...
		name: "Swimper",
		types: ["Water"],
		baseStats: { hp: 60, atk: 60, def: 85, spa: 70, spd: 85, spe: 110 },
		abilities: { 0: "Flee" },
		heightm: 0.1,
		weightkg: 0.1,
		color: "Red",
	...
	krilturn: {
		...
		name: "Krilturn",
		types: ["Water"],
		baseStats: { hp: 85, atk: 110, def: 60, spa: 60, spd: 70, spe: 85 },
		abilities: { 0: "Kickback" },
		heightm: 0.2,
		weightkg: 0.1,
		color: "Blue",
		eggGroups: ["Water 1", "Bug"],
	...
	gallidune: {
		...
		name: "Gallidune",
		types: ["Flying","Ground"],
		baseStats: { hp: 50, atk: 71, def: 57, spa: 21, spd: 40, spe: 56 },
		abilities: { 0: "Sand Veil", H: "Stamina" },
		heightm: 0.5,
		weightkg: 25.0,
		color: "Brown",
		evos: ["Terracan"],
	...
	terracan: {
		...
		name: "Terracan",
		types: ["Flying","Ground"],
		baseStats: { hp: 85, atk: 91, def: 77, spa: 53, spd: 70, spe: 79 },
		abilities: { 0: "Free Bird", H: "Stamina" },
		heightm: 1.7,
		weightkg: 85.0,
		color: "Brown",
		prevo: "Gallidune",
	...
	skorhaan: {
		...
		name: "Skorhaan",
		types: ["Flying","Ground"],
		baseStats: { hp: 87, atk: 109, def: 90, spa: 66, spd: 77, spe: 91 },
		abilities: { 0: "Free Bird", H: "Stamina" },
		heightm: 2.2,
		weightkg: 110.0,
		color: "Brown",
	...
	pyrotechnant: {
		...
		name: "Pyrotechnant",
		types: ["Fire","Bug"],
		baseStats: { hp: 40, atk: 85, def: 60, spa: 60, spd: 70, spe: 65 },
		abilities: { 0: "Pyrotechnic", 1: "Aftermath", H: "Swarm" },
		heightm: 0.4,
		weightkg: 7.3,
		color: "Red",
		evos: ["Nitroglycerant"],
	...
	nitroglycerant: {
		...
		name: "Nitroglycerant",
		types: ["Fire","Bug"],
		baseStats: { hp: 90, atk: 110, def: 70, spa: 60, spd: 70, spe: 65 },
		abilities: { 0: "Pyrotechnic", 1: "Aftermath ", H: "Swarm" },
		heightm: 0.8,
		weightkg: 20.9,
		color: "Red",
	...
	nucleant: {
		...
		name: "Nucleant",
		types: ["Fire","Bug"],
		baseStats: { hp: 90, atk: 140, def: 85, spa: 50, spd: 70, spe: 90 },
		abilities: { 0: "Pyrotechnic", 1: "Aftermath", H: "Swarm" },
		heightm: 1.7,
		weightkg: 41.2,
		color: "Red",
		prevo: "Nitroglycerant",
		evoLevel: 34,
		eggGroups: ["Bug"],
		gen: 9,
	},
	chelystary: {
		...
		name: "Chelystary",
		types: ["Ghost","Rock"],
		baseStats: { hp: 120, atk: 60, def: 57, spa: 33, spd: 40, spe: 10 },
		abilities: { 0: "Insomnia", 1: "Solid Rock", H: "Natural Cure" },
		heightm: 1.5,
		weightkg: 71.2,
		color: "Brown",
		evos: ["Sedimentary"],
	...
	sedimentary: {
		...
		name: "Sedimentary",
		types: ["Ghost","Rock"],
		baseStats: { hp: 156, atk: 85, def: 100, spa: 54, spd: 80, spe: 20 },
		abilities: { 0: "Insomnia", 1: "Solid Rock", H: "Natural Cure" },
		heightm: 3.9,
		weightkg: 295.0,
		color: "Brown",
	...
	ankydoe: {
		...
		name: "Ankydoe",
		types: ["Rock","Fighting"],
		baseStats: { hp: 59, atk: 96, def: 95, spa: 29, spd: 44, spe: 32 },
		abilities: { 0: "Sturdy", H: "Iron Fist" },
		heightm: 1.0,
		weightkg: 123.0,
		color: "Brown",
		evos: ["Ankayoe"],
	...
	ankayoe: {
		...
		name: "Ankayoe",
		types: ["Rock","Fighting"],
		baseStats: { hp: 92, atk: 139, def: 131, spa: 40, spd: 51, spe: 42 },
		abilities: { 0: "Sturdy", H: "Iron Fist" },
		heightm: 1.7,
		weightkg: 282.7,
		color: "Brown",
	...
	tirips: {
		...
		name: "Tirips",
		types: ["Fairy","Ghost"],
		baseStats: { hp: 50, atk: 50, def: 75, spa: 95, spd: 75, spe: 95 },
		abilities: { 0: "Levitate", H: "Trace" },
		heightm: 0.2,
		weightkg: 0.1,
		color: "Purple",
		eggGroups: ["Amorphous"],
		otherFormes: ["Tirips-Pot", "Tirips-Hat", "Tirips-Cloak", "Tirips-Flask", "Tirips-Orb"],
		formeOrder: ["Tirips", "Tirips-Pot", "Tirips-Hat", "Tirips-Cloak", "Tirips-Flask", "Tirips-Orb"],
		gen: 9,
	},
	tiripspot: {
		num: -1027,
		...
		forme: "Pot",
		types: ["Fairy","Steel"],
		baseStats: { hp: 50, atk: 107, def: 107, spa: 105, spd: 86, spe: 65 },
		abilities: { 0: "Levitate", H: "Heatproof" },
		heightm: 0.4,
		weightkg: 9.1,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	tiripscloak: {
		...
		forme: "Cloak",
		types: ["Fairy","Dark"],
		baseStats: { hp: 50, atk: 107, def: 105, spa: 65, spd: 86, spe: 107 },
	...
	tiripsflask: {
		...
		forme: "Flask",
		types: ["Fairy","Poison"],
		baseStats: { hp: 50, atk: 107, def: 107, spa: 86, spd: 105, spe: 65 },
	...
	tiripsorb: {
		...
		forme: "Orb",
		types: ["Fairy","Rock"],
		baseStats: { hp: 50, atk: 65, def: 105, spa: 107, spd: 107, spe: 86 },
	...
	cerberock: {
		...
		name: "Cerberock",
		types: ["Rock","Dragon"],
		baseStats: { hp: 60, atk: 60, def: 60, spa: 50, spd: 50, spe: 50 },
		abilities: { 0: "Solid Rock", 1: "Sturdy", H: "Rock Head" },
		heightm: 0.6,
		weightkg: 70.0,
		color: "Brown",
		evoItem: "King's Rock",
	...
	hydrock: {
		...
		name: "Hydrock",
		types: ["Rock","Dragon"],
		baseStats: { hp: 110, atk: 110, def: 110, spa: 70, spd: 70, spe: 70 },
		abilities: { 0: "Solid Rock", 1: "Sturdy", H: "Rock Head" },
		heightm: 3.3,
		weightkg: 780.0,
		color: "Gray",
	...
	krakentrap: {
		...
		name: "Krakentrap",
		types: ["Water","Fighting"],
		baseStats: { hp: 95, atk: 125, def: 90, spa: 70, spd: 80, spe: 80 },
	...
	calfloat: {
		...
		name: "Calfloat",
		types: ["Flying"],
		baseStats: { hp: 80, atk: 40, def: 45, spa: 70, spd: 50, spe: 5 },
		abilities: { 0: "Cloud Nine", 1: "Wind Rider", H: "Water Veil" },
		heightm: 1.2,
		weightkg: 6.8,
		color: "Blue",
		evos: ["Sumbaoar"],
	...
	sumbaoar: {
		...
		name: "Sumbaoar",
		types: ["Flying"],
		baseStats: { hp: 108, atk: 60, def: 66, spa: 90, spd: 62, spe: 20 },
		abilities: { 0: "Cloud Nine", 1: "Wind Rider", H: "Water Veil" },
		heightm: 4.6,
		weightkg: 16.8,
		color: "Blue",
	...
	buyoelago: {
		...
		name: "Buyoelago",
		types: ["Flying"],
		baseStats: { hp: 160, atk: 95, def: 65, spa: 120, spd: 70, spe: 30 },
		abilities: { 0: "Cloud Nine", 1: "Wind Rider", H: "Cloud Spewer" },
		heightm: 15.2,
		weightkg: 84.0,
		color: "Blue",
		prevo: "Sumbaoar",
	...
	innoculus: {
		...
		name: "Innoculus",
		types: ["Fighting","Psychic"],
		baseStats: { hp: 50, atk: 60, def: 57, spa: 50, spd: 30, spe: 75 },
	...
	malhinculus: {
		...
		name: "Malhinculus",
		types: ["Fighting","Dark"],
		baseStats: { hp: 135, atk: 125, def: 80, spa: 125, spd: 80, spe: 55 },
		abilities: { 0: "Eye of Malice", H: "Serene Grace" },
		heightm: 2.7,
		weightkg: 297.1,
		color: "Blue",
		prevo: "Homunkylus",
	...
	toillitrub: {
		...
		name: "Toillitrub",
		types: ["Poison","Fairy"],
		baseStats: { hp: 30, atk: 30, def: 30, spa: 70, spd: 50, spe: 90 },
		abilities: { 0: "Power of Alchemy", H: "Prankster" },
		heightm: 0.7,
		weightkg: 2.4,
		color: "Purple",
		evos: ["Caldribub"],
	...
	caldribub: {
		...
		name: "Caldribub",
		types: ["Poison","Fairy"],
		baseStats: { hp: 60, atk: 50, def: 85, spa: 90, spd: 85, spe: 50 },
		abilities: { 0: "Power of Alchemy", H: "Liquid Ooze" },
		heightm: 1.1,
		weightkg: 181.4,
		color: "Purple",
		prevo: "Toillitrub",
	...
	cacaldrid: {
		...
		name: "Cacaldrid",
		types: ["Poison","Fairy"],
		baseStats: { hp: 80, atk: 70, def: 110, spa: 130, spd: 120, spe: 90 },
		abilities: { 0: "Power of Alchemy", H: "Liquid Ooze" },
		heightm: 2.2,
		weightkg: 317.5,
		color: "Purple",
	...
	cirnyx: {
		...
		gender: "F",
		types: ["Dark","Electric"],
		baseStats: { hp: 76, atk: 106, def: 106, spa: 115, spd: 88, spe: 109 },
		abilities: { 0: "Neuroforce", H: "Electric Surge" },
		heightm: 2.2,
		weightkg: 3.0,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	centignet: {
		...
		types: ["Bug","Dragon"],
		gender: "N",
		baseStats: { hp: 89, atk: 97, def: 107, spa: 127, spd: 79, spe: 101 },
		abilities: { 0: "Magnet Pull", 1: "Technician", H: "Fly Trap" },
		heightm: 2.9,
		weightkg: 70.0,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	titanicrown: {
		...
		types: ["Water","Steel"],
		gender: "N",
		baseStats: { hp: 120, atk: 115, def: 120, spa: 130, spd: 120, spe: 75 },
		abilities: { 0: "Sunken Coral Crown" },
		heightm: 18.0,
		weightkg: 999.0,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	levianarctic: {
		...
		types: ["Ice","Ghost"],
		gender: "N",
		baseStats: { hp: 170, atk: 130, def: 135, spa: 100, spd: 135, spe: 10 },
		abilities: { 0: "Goliath" },
		heightm: 16.0,
		weightkg: 999.9,
		color: "Blue",
	...
	aggronheroguea: {
		num: 306,
		name: "Aggron-Heroguea",
		baseSpecies: "Aggron",
		forme: "Heroguea",
		types: ["Steel", "Dragon"],
		baseStats: { hp: 80, atk: 80, def: 110, spa: 80, spd: 110, spe: 70 },
		abilities: { 0: "Mirror Armor", 1: "Regenerator", H: "Heavy Metal" },
		heightm: 2.0,
		weightkg: 360.0,
		color: "Gray",
		prevo: "Lairon",
	...
	spiritombheroguea: {
		num: 442,
		name: "Spiritomb-Heroguea",
		baseSpecies: "Spiritomb",
		forme: "Heroguea",
		types: ["Electric", "Ground"],
		baseStats: { hp: 92, atk: 50, def: 92, spa: 108, spd: 108, spe: 35 },
	...
	wavleyemega: {
		...
		forme: "Mega",
		types: ["Dark", "Water"],
		baseStats: { hp: 50, atk: 115, def: 85, spa: 125, spd: 85, spe: 20 },
	...
	dustnee: {
		...
		name: "Dustnee",
		types: ["Ground", "Fairy"],
		baseStats: { hp: 55, atk: 40, def: 65, spa: 111, spd: 90, spe: 98 },
	...
	tanookraze: {
		...
		baseStats: { hp: 74, atk: 102, def: 78, spa: 84, spd: 58, spe: 112 },
	...
	clodsiremega: {
		...
		forme: "Mega",
		types: ["Poison", "Ground"],
		baseStats: { hp: 130, atk: 100, def: 70, spa: 70, spd: 140, spe: 20 },
		abilities: { 0: "Airhead"},
		heightm: 2.5,
		weightkg: 55,
		color: "Brown",
	...
	cincchiller: {
		...
		name: "Cincchiller",
		types: ["Normal", "Ice"],
		baseStats: { hp: 80, atk: 115, def: 70, spa: 75, spd: 75, spe: 120 },
		abilities: { 0: "Figure Skater", 1: "Technician", H: "Skill Link" },
		heightm: 0.6,
		weightkg: 8.4,
		color: "Gray",
		prevo: "Cinccino",
	...
	pricktoad: {
		...
		name: "Pricktoad",
		types: ["Grass"],
		baseStats: { hp: 80, atk: 55, def: 65, spa: 35, spd: 35, spe: 45 },
		abilities: { 0: "Iron Barbs", 1: "Water Absorb",  H: "Sand Rush" },
		heightm: 1.0,
		weightkg: 50.0,
		color: "Brown",
		evos: ["Moguaro"],
	...
	moguaro: {
		...
		name: "Moguaro",
		types: ["Grass", "Poison"],
		baseStats: { hp: 90, atk: 105, def: 115, spa: 40, spd: 65, spe: 80 },
		abilities: { 0: "Iron Barbs", 1: "Water Absorb",  H: "Sand Rush" },
		heightm: 2.0,
		weightkg: 300.0,
		color: "Brown",
	...
	tropecetary: {
		...
		name: "Tropecetary",
		types: ["Grass", "Electric"],
		baseStats: { hp: 74, atk: 116, def: 73, spa: 61, spd: 76, spe: 110 },
		abilities: { 0: "Defiant", 1: "Regenerator",  H: "Long Reach" },
		heightm: 1.3,
		weightkg: 4.3,
		color: "Green",
	...
	stuttlesnek: {
		...
		name: "Stuttlesnek",
		types: ["Psychic"],
		baseStats: { hp: 45, atk: 37, def: 25, spa: 105, spd: 55, spe: 83 },
		abilities: { 0: "Soundproof", 1: "Shed Skin",  H: "Rattled" },
		heightm: 0.9,
		weightkg: 2.3,
		color: "Pink",
		evos: ["Lyrikhiss"],
	...
	lyrikhiss: {
		...
		name: "Lyrikhiss",
		types: ["Psychic"],
		baseStats: { hp: 70, atk: 62, def: 50, spa: 130, spd: 80, spe: 108 },
		abilities: { 0: "Soundproof", 1: "Shed Skin",  H: "Multiscale" },
		heightm: 2.5,
		weightkg: 14.5,
		color: "Pink",
		prevo: "Stuttlesnek",
	...
	terracluse: {
		...
		name: "Terracluse",
		types: ["Ground", "Normal"],
		baseStats: { hp: 60, atk: 107, def: 60, spa: 116, spd: 60, spe: 106 },
		abilities: { 0: "Refrigerate", 1: "Pyrotechnic",  H: "Galvanize" },
		heightm: 0.7,
		weightkg: 10.9,
		color: "Brown",
		eggGroups: ["Amorphous"],
	...
	komalaheroguea: {
		num: 775,
		name: "Komala-Heroguea",
		baseSpecies: "Komala",
		forme: "Heroguea",
		types: ["Normal", "Ghost"],
		baseStats: { hp: 65, atk: 110, def: 65, spa: 75, spd: 100, spe: 65 },
		abilities: { 0: "Comatose" },
		heightm: 0.4,
		weightkg: 9.0,
		color: "Gray",
	...
	nomala: {
		...
		name: "Nomala",
		types: ["Normal", "Ghost"],
		baseStats: { hp: 65, atk: 120, def: 65, spa: 65, spd: 115, spe: 90 },
		abilities: { 0: "Guts", H: "Phantasmalate" },
		heightm: 0.8,
		weightkg: 17.1,
		color: "Gray",
		prevo: "Komala-Heroguea",
		evoType: "other",
		evoCondition: "Have Sleep Talk use Rage 10 times",
		eggGroups: ["Field"],
	},
	sharbine: {
		num: -1062,
		name: "Sharbine",
		types: ["Water", "Electric"],
		baseStats: { hp: 95, atk: 65, def: 85, spa: 100, spd: 75, spe: 65 },
		abilities: { 0: "Wind Power", 1: "Propeller Tail",  H: "Static" },
		heightm: 2.0,
		weightkg: 120.0,
		color: "Blue",
	...
	krushodo: {
		...
		name: "Krushodo",
		types: ["Dragon", "Psychic"],
		baseStats: { hp: 80, atk: 114, def: 110, spa: 62, spd: 52, spe: 97 },
		abilities: { 0: "Strong Jaw", 1: "Anticipation",  H: "Rough Skin" },
		heightm: 3.0,
		weightkg: 135.0,
		color: "Red",
		eggGroups: ["Dragon"],
	...
	wisce: {
		...
		name: "Wisce",
		types: ["Ice", "Fire"],
		baseStats: { hp: 30, atk: 40, def: 45, spa: 55, spd: 35, spe: 50 },
		abilities: { 0: "Flame Body", 1: "Dazzling",  H: "Flash Fire" },
		heightm: 0.3,
		weightkg: 10.9,
		color: "Blue",
		evos: ["Danahan"],
	...
	danahan: { 
		...
		name: "Danahan",
		types: ["Ice", "Fire"],
		baseStats: { hp: 70, atk: 91, def: 45, spa: 125, spd: 80, spe: 99 },
		abilities: { 0: "Figure Skater", 1: "Dazzling",  H: "Flash Fire" },
		heightm: 1.8,
		weightkg: 65.8,
		color: "Blue",
		prevo: "Wisce",
	...
	wormir: {
		...
		name: "Wormir",
		types: ["Rock", "Bug"],
		baseStats: { hp: 20, atk: 35, def: 30, spa: 35, spd: 40, spe: 90 },
		abilities: { 0: "Magic Bounce", 1: "Weak Armor",  H: "Sand Stream" },
		heightm: 0.1,
		weightkg: 0.9,
		color: "Brown",
		evos: ["Chrystalis"],
	...
	chrystalis: {
		...
		name: "Chrystalis",
		types: ["Rock", "Fire"],
		baseStats: { hp: 40, atk: 60, def: 30, spa: 65, spd: 70, spe: 110 },
		abilities: { 0: "Magic Bounce", 1: "Weak Armor",  H: "Sand Stream" },
		heightm: 0.6,
		weightkg: 5.8,
		color: "Blue",
	...
	saintiglaz: {
		...
		name: "Saintiglaz",
		types: ["Rock", "Fire"],
		baseStats: { hp: 60, atk: 85, def: 38, spa: 85, spd: 86, spe: 136 },
		abilities: { 0: "Magic Bounce", 1: "Weak Armor",  H: "Sand Stream" },
		heightm: 0.8,
		weightkg: 3.6,
		color: "Blue",
	...
	khullchis: {
		...
		name: "Khullchis",
		types: ["Steel", "Fire"],
		baseStats: { hp: 95, atk: 90, def: 60, spa: 110, spd: 95, spe: 70 },
		abilities: { 0: "Flame Body", 1: "Bulletproof",  H: "Reckless" },
		heightm: 3.0,
		weightkg: 650.0,
		color: "Brown",
		eggGroups: ["Field", "Mineral"],
	...
	hypsyriff: {
		...
		name: "Hypsyriff",
		types: ["Water", "Rock"],
		baseStats: { hp: 60, atk: 82, def: 74, spa: 125, spd: 72, spe: 107 },
		abilities: { 0: "Sniper", 1: "Sturdy",  H: "Skill Link" },
		heightm: 0.4,
		weightkg: 1.1,
		color: "Yellow",
		eggGroups: ["Water 2"],
	...
	bubbafrog: {
		...
		name: "Bubbafrog",
		types: ["Water", "Fairy"],
		baseStats: { hp: 72, atk: 60, def: 50, spa: 85, spd: 122, spe: 104 },
		abilities: { 0: "Sticky Hold", 1: "Bulletproof",  H: "Gooey" },
		heightm: 0.7,
		weightkg: 22.7,
		color: "Blue",
		eggGroups: ["Water 1", "Water 2"],
	...
	anemester: {
		...
		name: "Anemester",
		types: ["Water"],
		baseStats: { hp: 70, atk: 30, def: 60, spa: 30, spd: 60, spe: 30 },
		abilities: { 0: "Sticky Hold", 1: "Suction Cups",  H: "Prankster" },
		heightm: 0.5,
		weightkg: 16.8,
		color: "Green",
		evos: ["Anenite", "Anemizard"],
	...
	anenite: {
		...
		name: "Anenite",
		types: ["Water", "Steel"],
		baseStats: { hp: 100, atk: 90, def: 80, spa: 55, spd: 70, spe: 55 },
		abilities: { 0: "Sticky Hold", 1: "Suction Cups",  H: "Intimidate" },
		heightm: 1.4,
		weightkg: 93.0,
		color: "Blue",
		prevo: "Anemester",
	...
	anemizard: {
		...
		name: "Anemizard",
		types: ["Water", "Psychic"],
		baseStats: { hp: 100, atk: 55, def: 70, spa: 90, spd: 80, spe: 55 },
		abilities: { 0: "Sticky Hold", 1: "Suction Cups",  H: "Magic Guard" },
		heightm: 1.2,
		weightkg: 72.6,
		color: "Green",
		prevo: "Anemester",
	...
	sloolooth: {
		...
		name: "Sloolooth",
		types: ["Grass"],
		baseStats: { hp: 64, atk: 10, def: 50, spa: 67, spd: 67, spe: 10 },
		abilities: { 0: "Flower Veil", 1: "Grass Pelt",  H: "Slow Start" },
		heightm: 0.4,
		weightkg: 1.8,
		color: "Green",
		evos: ["Petrioth"],
	...
	akasloth: {
		...
		name: "Akasloth",
		types: ["Grass", "Psychic"],
		baseStats: { hp: 70, atk: 45, def: 70, spa: 114, spd: 145, spe: 20 },
		abilities: { 0: "Flower Veil", 1: "Grassy Surge",  H: "Slow Start" },
		heightm: 1.0,
		weightkg: 11.8,
		color: "Green",
	...
	shuppetheroguea: { 
		num: 353,
		name: "Shuppet-Heroguea",
		baseSpecies: "Shuppet",
		forme: "Heroguea",
		types: ["Ghost", "Grass"],
		baseStats: { hp: 52, atk: 52, def: 68, spa: 33, spd: 48, spe: 42 },
		abilities: { 0: "Prankster", 1: "Harvest", H: "Cursed Body" },
		heightm: 0.6,
		weightkg: 1.5,
		color: "Purple",
		evos: ["Strawnette"],
	...
	strawnette: {
		...
		name: "Strawnette",
		types: ["Ghost", "Grass"],
		baseStats: { hp: 64, atk: 115, def: 68, spa: 50, spd: 66, spe: 92 },
		abilities: { 0: "Terrify", 1: "Harvest", H: "Long Reach" },
		heightm: 1.7,
		weightkg: 18.1,
		color: "Purple",
		prevo: "Shuppet-Heroguea",
		evoLevel: 37,
		eggGroups: ["Amorphous"],
	},
	figgipiggi: {
		...
		name: "Figgipiggi",
		types: ["Grass"],
		baseStats: { hp: 55, atk: 65, def: 40, spa: 40, spd: 65, spe: 35 },
		abilities: { 0: "Dry Skin", 1: "Oblivious",  H: "Gluttony" },
		heightm: 0.6,
		weightkg: 46.0,
		color: "Brown",
		evos: ["Shrubrute"],
	...
	shrubrute: {
		...
		name: "Shrubrute",
		types: ["Grass", "Ground"],
		baseStats: { hp: 75, atk: 85, def: 55, spa: 55, spd: 85, spe: 50 },
		abilities: { 0: "Dry Skin", 1: "Oblivious",  H: "Gluttony" },
		heightm: 1.3,
		weightkg: 170.0,
		color: "Brown",
	...
	arboaracious: {
		...
		name: "Arboaracious",
		types: ["Grass", "Ground"],
		baseStats: { hp: 90, atk: 125, def: 70, spa: 60, spd: 110, spe: 65 },
		abilities: { 0: "Dry Skin", 1: "Oblivious",  H: "Gluttony" },
		heightm: 1.9,
		weightkg: 295.0,
		color: "Green",
